package com.marchuk0.lab4.nfa;


import com.marchuk0.lab4.io.utils.Pair;

import java.util.HashMap;
import java.util.HashSet;
import java.util.Vector;

import static com.marchuk0.lab4.nfa.NFAUtil.transitionTableDebugMessage;
...
public class IntegratedNFA {
    ...
    public IntegratedNFA(Vector<Pair<String, String>> regExps) throws Exception {
        ...
        for (Pair<String, String> regExp : regExps) {
            integrate(NFAUtil.regExpToNFA(regExp.getFirst()), regExp.getSecond());
        }
    }
