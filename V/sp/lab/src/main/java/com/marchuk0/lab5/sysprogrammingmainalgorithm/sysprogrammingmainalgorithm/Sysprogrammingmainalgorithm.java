...
import com.marchuk0.lab5.sysprogrammingmainalgorithm.sysprogrammingmainalgorithm.JavaTeacherLib.LlkContext;
        ...
        do {
            ...
            switch (codeAction) {
                case 1: //1. Прочитати граматику з файла",
                    ...
                    testLang = new MyLang1(fileName, llk);
                ...
                case 9:    //Пошук ліворекурсивних нетерміналів"
                    testLang.leftRecursNonTerminal();
                    break;
                ...
                case 11:  //Пошук праворекурсивних нетерміналів"
                    testLang.rightRecursNonTerminal();
                    break;
